<%-- 
    Document   : trasfer_money
    Created on : 06-Jul-2022, 11:15:28 am
    Author     : Dell
--%>
...
<html>
    ...
    <title>Tranfer Money to another account </title>
    </head>
<body>
    <section class="home">
        <header class="header">
        ...
        <section class="otp_session">
            <section class="otp_inside_session_main">
                ...
                <form action="../transfer_servlet_main" class="otp_form" method="post">
                    <div class="otp_form_div1">
                        <div class="otp_form_number">Account Number *</div>
                        <div class="otp_from_input_div"> <input type="text" name="transfer_account_number"
                                placeholder="Enter Account no" required></div>
                    </div>
                    <div class="otp_form_div2">
                        <div class="otp_form_email">Money *</div>
                        <div> <input type="text" name="transfer_money" class="otp_form_email_input"
                                placeholder="Enter Money you want to deposit" required></div>
                    </div>
                    ...
                    <section class="otp_buttons">
                        <div class="otp_from_logout">
                            <a href="../HTML/home.html"> <button type="button">Logout</button> </a>
                        </div>
                        <div class="otp_from_next">
                            <a href="#"> <button type="submit">Continue</button> </a>
                        </div>
                        <div class="otp_from_cancle">
                            <a href="payment1_dashboard.jsp"> <button type="button">Cancle</button> </a>
                        </div>
                    </section>
                </form>
            </section>
